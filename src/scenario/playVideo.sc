patterns:
        ...
        $DBK = {* покаж* (новобанк | ново банк  | ней банк | Digital|дигит*|диджит*|цифров*|прилож*|нео банк*|необанк*|гео банк*|геобанк*)  * (Герман* | Европ*) *}
        ...
        $Q8 = {* расскаж* * (новобанк | ново банк  | необанк*|нео банк*|геобанк*|гео банк*) * (герман*|европ*) *}
        ...
        $Q16 = {* (ROE | сир | рои | приб* | опердох* | опер доход | CIR | ЧКД | (колич* клиент*)) * казахст* *}
        
        $Q17 = {* (ROE | приб* | рои | сир |  опердох* | опер доход | CIR | ЧКД | (колич* клиент*)) * (беларус*|белорус*) *}

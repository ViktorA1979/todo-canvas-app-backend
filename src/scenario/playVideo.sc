patterns:
        $ESG2 = ([расскажи | покажи | представь | презентуй] что [мы] [делаем] в (Герман* | Европ*) [в части | по | для | по теме | в] ( (ESG | и эс джи) | [развит*] зелён* банк* |  (green | грим | грен) (banking | бэнкин* | банкин*)  )  | Как* зелен* продукт* [мы] [будем] предлаг* [клиент*] в (Герман* | Европ*) | Покаж* зеленый банк в (Герман* | Европ*))
         ...
         $DBK2 = (Покажи какие функции у нашего цифрового банка в Европе|Продемонстрируй функционал нашего цифрового банка в Европе|Покажи как выглядит приложение Digital банка в Европе|Покажи какое приложение мы хотим запустить в Европе в 2022 году|Покажи цифровой Банк в Европе|Что мы строим в Европе)

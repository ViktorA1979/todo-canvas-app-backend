theme: /
    ...
    state: ЗапускВидео2
        q!:  ( Что мы делаем в (Герман* | Европ*) [в части | по | для ] ( (ESG | и эс джи) | развит* зелён* банк* |  (green | грим | грен) (banking | бэнкинг | бэнкинг | банкинг)  ) ) | Как* зелен* продукт* [мы] [будем] предлаг* клиент* в (Герман* | Европ*) | Покажи зеленый банк в (Герман* | Европ*))

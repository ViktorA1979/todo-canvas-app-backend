theme: /
    ...
    state: ЗапускВидео2
        q!:  ( Что мы делаем в Германии [в части | по | для ] ( (ESG | и эс джи) | развит* зелён* банк* | (green banking| (грим (бэнкинг | бэнкинг | банкинг) )  ) ) | Какие зеленые продукты мы будем предлагать клиентам в Европе | Покажи зеленый банк в Европе)

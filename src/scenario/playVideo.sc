...
theme: /
    ...
    state: ЗапускВидео2
        q!:  ([расскажи | покажи | представь | презентуй] что [мы] [делаем] в (Герман* | Европ*) [в части | по | для | по теме | в] ( (ESG | и эс джи) | [развит*] зелён* банк* |  (green | грим | грен) (banking | бэнкин* | банкин*)  )  | Как* зелен* продукт* [мы] [будем] предлаг* [клиент*] в (Герман* | Европ*) | Покаж* зеленый банк в (Герман* | Европ*))
